...
`config.yaml`
### eu uso 7 bots auxiliares e 3 segundos de delay, 24mb chunk, no upload tendo 100mb, faça uma estimativa com base no seu upload na quantidade de bots e no delay, caso utilizar pouco delay e muitos bots pode resultar na queda da internet no pc por 2 a 3 minutos.
meu 
```yaml
# Tokens dos bots
tokens:
